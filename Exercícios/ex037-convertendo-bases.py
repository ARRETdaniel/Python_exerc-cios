...
print('\n{}Escolha uma base para converção: {}'.format(
    cor['title'], cor['limpa']))
...
if base == 1:
    print('{} em {}binário{} é {}'.format(
        num, cor['amarelo'], cor['limpa'], bin(num)[2:]))
elif base == 2:
    print('{} em {}octal{} é {}'.format(
        num, cor['amarelo'], cor['limpa'], oct(num)[2:]))
elif base == 3:
    print('{} em {}hexadecimal{} é {}'.format(
        num, cor['amarelo'], cor['limpa'], hex(num)[2:]))
else:
